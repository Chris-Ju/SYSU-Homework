...
public class GenGameObject : MonoBehaviour
{
    ...
    public void next()
    {
        if (boat_side == 1 && devils_start.Count == 3 && priests_start.Count == 3 && devils_end.Count == 0 
            && priests_end.Count == 0)
        {
            devilStartOnBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 2 && priests_start.Count == 3 && devils_end.Count == 0
            && priests_end.Count == 0)
        {
            devilStartOnBoat();
        }
        else if(boat_side == 1 && devils_start.Count == 1 && priests_start.Count == 3 && devils_end.Count == 0
            && priests_end.Count == 0)
        {
            moveBoat();
        }
        else if(boat_side == 2 && devils_start.Count == 1 && priests_start.Count == 3 && devils_end.Count == 0
            && priests_end.Count == 0)
        {
            getOffTheBoat(1);
        }
        else if(boat_side == 2 && devils_start.Count == 1 && priests_start.Count == 3 && devils_end.Count == 1
            && priests_end.Count == 0)
        {
            moveBoat();
        }
        else if(boat_side == 1 && devils_start.Count == 1 && priests_start.Count == 3 && devils_end.Count == 1
            && priests_end.Count == 0)
        {
            devilStartOnBoat();
        }
        else if(boat_side == 1 && devils_start.Count == 0 && priests_start.Count == 3 && devils_end.Count == 1
            && priests_end.Count == 0)
        {
            moveBoat();
        }
        else if(boat_side == 2 && devils_start.Count == 0 && priests_start.Count == 3 && devils_end.Count == 1
            && priests_end.Count == 0)
        {
            getOffTheBoat(1);
        }
        else if (boat_side == 2 && devils_start.Count == 0 && priests_start.Count == 3 && devils_end.Count == 2
            && priests_end.Count == 0)
        {
            moveBoat();
        }
        else if(boat_side == 1 && devils_start.Count == 0 && priests_start.Count == 3 && devils_end.Count == 2
            && priests_end.Count == 0)
        {
            getOffTheBoat(0);
        }
        else if (boat_side == 1 && devils_start.Count == 1 && priests_start.Count == 3 && devils_end.Count == 2
            && priests_end.Count == 0)
        {
            priestStartOnBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 1 && priests_start.Count == 2 && devils_end.Count == 2
            && priests_end.Count == 0)
        {
            priestStartOnBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 1 && priests_start.Count == 1 && devils_end.Count == 2
            && priests_end.Count == 0)
        {
            moveBoat();
        }
        else if (boat_side == 2 && devils_start.Count == 1 && priests_start.Count == 1 && devils_end.Count == 2
            && priests_end.Count == 0)
        {
            getOffTheBoat(0);
        }
        ...
        else if (boat_side == 2 && devils_start.Count == 1 && priests_start.Count == 1 && devils_end.Count == 1
            && priests_end.Count == 1)
        {
            moveBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 1 && priests_end.Count == 1 && devils_end.Count == 1
            && priests_start.Count == 1)
        {
            getOffTheBoat(0);
        }
        else if (boat_side == 1 && devils_start.Count == 2 && priests_end.Count == 1 && devils_end.Count == 1
            && priests_start.Count == 1)
        {
            priestStartOnBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 2 && priests_end.Count == 1 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            moveBoat();
        }
        else if (boat_side == 2 && devils_start.Count == 2 && priests_end.Count == 1 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            getOffTheBoat(0);
        }
        else if (boat_side == 2 && devils_start.Count == 2 && priests_end.Count == 2 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            getOffTheBoat(1);
        }
        else if (boat_side == 2 && devils_start.Count == 2 && priests_end.Count == 3 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            devilEndOnBoat();
        }
        else if (boat_side == 2 && devils_start.Count == 2 && priests_end.Count == 3 && devils_end.Count == 0
            && priests_start.Count == 0)
        {
            moveBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 2 && priests_end.Count == 3 && devils_end.Count == 0
            && priests_start.Count == 0)
        {
            devilStartOnBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 1 && priests_end.Count == 3 && devils_end.Count == 0
            && priests_start.Count == 0)
        {
            moveBoat();
        }
        else if (boat_side == 2 && devils_start.Count == 1 && priests_end.Count == 3 && devils_end.Count == 0
            && priests_start.Count == 0)
        {
            getOffTheBoat(0);
        }
        else if (boat_side == 2 && devils_start.Count == 1 && priests_end.Count == 3 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            moveBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 1 && priests_end.Count == 3 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            devilStartOnBoat();
        }
        else if (boat_side == 1 && devils_start.Count == 0 && priests_end.Count == 3 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            moveBoat();
        }
        else if (boat_side == 2 && devils_start.Count == 0 && priests_end.Count == 3 && devils_end.Count == 1
            && priests_start.Count == 0)
        {
            getOffTheBoat(0);
        }
        else if (boat_side == 2 && devils_start.Count == 0 && priests_end.Count == 3 && devils_end.Count == 2
            && priests_start.Count == 0)
        {
            getOffTheBoat(1);
        }
