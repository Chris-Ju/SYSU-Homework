...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	totalFrames = 8;
	Animation* gemmouseAnimation = Animation::create();

	for (int i = 0; i < totalFrames; i++)
	{
		sprintf(frameName, "gem-mouse-%d.png", i);
		gemmouseAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName));
	}
	gemmouseAnimation->setDelayPerUnit(0.1);
	AnimationCache::getInstance()->addAnimation(gemmouseAnimation, "gemmouseAnimation");
