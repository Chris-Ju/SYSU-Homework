            ...
            IMainPage_Bindings
        {
            ...
            private void Update_(global::MyList.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_View_Model(obj.View_Model, phase);
                    }
                }
            }
            private void Update_View_Model(global::MyList.ViewModels.TodoViewModels obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_View_Model_AllItems(obj.AllItems, phase);
                    }
                }
            }
            private void Update_View_Model_AllItems(global::System.Collections.ObjectModel.ObservableCollection<global::MyList.Models.TodoItem> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
